...
phonebook = Contacts()
phonebook.add_contacts('Wylie Pope', '(692) 802-2949', 'est@utquamvel.net', True)
phonebook.add_contacts('Cyrus Jackson', '(501) 472-5218', 'nibh@semsempererat.com', False)
...
# Клас Contacts містить змінну класу current_id. Ми будемо використовувати її 
# при додаванні нового контакту як унікального ідентифікатора контакту. 
# Коли ми додаємо новий контакт, то передаємо такі аргументи 
# в метод add_contacts: name, phone, email та favorite. 
# Метод повинен створити словник із зазначеними ключами та значеннями параметрів функції. 
# Також необхідно додати до словника новий ключ id, значенням якого 
# є значення змінної класу current_id.
