...
#
# Функція do_setup(args_dict, requiers, entry_points) повинна викликати функцію setup з параметрами словника args_dict
# та параметром install_requires, який набуває значення requiers. Третій параметр entry_points приймає словник,
