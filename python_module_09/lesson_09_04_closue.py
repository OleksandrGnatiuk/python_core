...
# Створіть функцію discount_price(discount), яка визначатиме в собі та повертатиме функцію розрахунку
# реальної ціни з урахуванням знижки.
#
# Виклик функції discount_price(discount) поверне функцію,
# яка розраховує ціну на товар зі знижкою, що дорівнює discount .
#
# Наприклад:
#
